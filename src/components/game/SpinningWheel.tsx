  ...
  const renderWheelSegments = () => {
    ...
    for (let i = 1; i <= state.maxSeats; i++) {
      ...
      segments.push(
        ...
        >
          <span className="mt-2 transform -rotate-90">{i}</span>
        </div>
      );
    }
    return segments;
    ...
    <div className="flex flex-col items-center space-y-8 py-8">
      ...
      <div className="relative">
        ...
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-2 z-20">
          <div className="w-0 h-0 border-l-8 border-r-8 border-b-16 border-l-transparent border-r-transparent border-b-game-white drop-shadow-lg"></div>
        </div>
        ...
        <div className="relative">
          <div
            ...
            style={{
              background: 'conic-gradient(from 0deg, #FF4136 6deg, #0074D9 6deg, #0074D9 12deg, #FF4136 12deg)'
            }}
          >
            {/* Center Circle */}
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-game-gold rounded-full border-4 border-game-white flex items-center justify-center z-10">
            ...
            {/* Outer Ring */}
            <div className="absolute inset-0 rounded-full border-4 border-game-white opacity-20"></div>
          </div>
        </div>
      </div>
